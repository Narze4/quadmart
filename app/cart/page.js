    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <p className="text-sm text-gray-400 mb-6">Nothing here yet — go find something great on the marketplace</p>
          <Link
            href="/marketplace"
            className="px-6 py-2.5 bg-green-500 hover:bg-green-700 text-white text-sm font-semibold rounded-xl transition-all duration-200 active:scale-95"
          >
            Browse Marketplace
          </Link>
        </div>
